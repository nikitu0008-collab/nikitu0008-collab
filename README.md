...
<div align="center">
  <!-- ИКОНКИ C++ И PYTHON С АДАПТИВНОЙ ТЕМОЙ -->
  ...
  <a href="https://www.python.org/">
    <picture>
      ...
      <img src="https://raw.githubusercontent.com/tandpfun/skill-icons/main/icons/Python-Light.svg" height="55" alt="Python"/>
    </picture>
  </a>
  <span> = ⚡️🚀</span>
</div>

<!-- ДЕКОРАТИВНЫЙ РАЗДЕЛИТЕЛЬ "BACKEND GEARS" -->
<div align="center">
  <img src="https://custom-icon-badges.demolab.com/badge/🖧%20%20CLIENT%20%E2%86%92%20API%20%E2%86%92%20SERVICE%20%E2%86%92%20DB%20%20🗄️-backend?style=for-the-badge&logo=server&logoColor=white&color=1e1e2f&labelColor=7C3AED"/>
</div>

<h1 align="center">
  <span style="background: linear-gradient(135deg, #7C3AED, #9F7AEA); background-clip: text; -webkit-background-clip: text; color: transparent;">👋 Nikita / Никита</span>
</h1>

<p align="center">
  <b>C++ Backend Engineer</b> — строю высокопроизводительные, надёжные сервисы. Python для прототипов, автоматизации и склеивания.
</p>

---

## 🧠 Обо мне / About me (Rus / Eng)

<div style="display: flex; gap: 20px; flex-wrap: wrap; justify-content: center; margin: 20px 0;">
  
  <!-- Русская карточка -->
  <div style="flex: 1; min-width: 260px; background: rgba(124, 58, 237, 0.07); border-radius: 32px; padding: 22px; backdrop-filter: blur(2px); border: 1px solid rgba(124, 58, 237, 0.3);">
    <h3 align="center">🇷🇺 Русский</h3>
    <p align="justify">
      Backend-разработчик на C++, фокус на низкоуровневую оптимизацию, многопоточность и асинхронность (Boost.Asio). Начинал с Python, до сих пор использую для быстрого прототипирования, написания парсеров и вспомогательных скриптов.
    </p>
    <ul>
      <li>🔭 Изучаю C++20/23, паттерны конкурентного программирования</li>
      <li>💻 Разрабатываю высоконагруженные бэкенд-сервисы и сетевые утилиты</li>
      <li>🌱 Помогаю новичкам в C++ разобраться с памятью, указателями и шаблонами</li>
      <li>⚡ Оптимизирую код до последнего такта, ловлю data races и deadlocks</li>
      <li>💬 Telegram: <b><a href="https://t.me/NikiZ1p">@NikiZ1p</a></b> | English — fluent</li>
      <li>📚 Metanit.com, cppreference.com — мои настольные книги</li>
    </ul>
  </div>
  ...
  <div style="flex: 1; min-width: 260px; background: rgba(124, 58, 237, 0.07); border-radius: 32px; padding: 22px; backdrop-filter: blur(2px); border: 1px solid rgba(124, 58, 237, 0.3);">
    ...
    <p align="justify">
      C++ Backend developer focusing on low‑level optimization, concurrency and async (Boost.Asio). Python for prototyping, parsers, and glue code.
    </p>
    <ul>
      <li>🔭 Diving into C++20/23, concurrency patterns</li>
      <li>💻 Building high‑performance backend services & networking tools</li>
      <li>🌱 Mentoring beginners in C++ (memory, pointers, templates)</li>
      <li>⚡ Squeezing cycles, fixing data races & deadlocks</li>
      <li>💬 Telegram: <b><a href="https://t.me/NikiZ1p">@NikiZ1p</a></b> | Russian, English</li>
      <li>📚 Go‑to: Metanit.com, cppreference.com</li>
    </ul>
  </div>
...
## 📈 Языковой профиль / Language focus

<div align="center">
  
| Язык | Уровень / использование |
|------|------------------------|
| **C++** | Основной — ежедневная работа. Глубокое понимание памяти, шаблонов, STL, многопоточности. |
| **Python** | Вспомогательный — парсинг, прототипы, автоматизация, тестирование. ООП, декораторы, итераторы, работа с файлами, requests/bs4. |
| **SQL** | Уверенный уровень — сложные JOIN, оконные функции, оптимизация запросов. |
| **Bash** | Скрипты сборки, деплоя, автоматизация рутины. |

</div>

---

## 🧩 Мои проекты (backend-ориентированные)
...
<div style="display: flex; flex-wrap: wrap; gap: 24px; justify-content: center; margin-top: 24px;">
  ...
  <div style="flex: 1; min-width: 280px; background: linear-gradient(145deg, #0c0c1a, #12122a); border-radius: 28px; padding: 22px; border: 1px solid rgba(124,58,237,0.5); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-6px)';this.style.borderColor='#9F7AEA'" onmouseout="this.style.transform='translateY(0)';this.style.borderColor='rgba(124,58,237,0.5)'">
      <h3>🎓 CppCraft</h3>
      <b>Stack:</b> C++17, STL, CMake 🛠️<br>
      Образовательный репозиторий: шаблоны проектирования, алгоритмы, best practices для C++ backend. Идеально для тех, кто хочет быстро войти в индустрию.<br>
      <i>Educational repo: design patterns, algorithms, best practices for C++ backend.</i><br>
      <a href="https://github.com/nikitu0008-collab/CppCraft">🔗 Перейти →</a>
  </div>

  <!-- College Messenger -->
  <div style="flex: 1; min-width: 280px; background: linear-gradient(145deg, #0c0c1a, #12122a); border-radius: 28px; padding: 22px; border: 1px solid rgba(124,58,237,0.5); transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-6px)';this.style.borderColor='#9F7AEA'" onmouseout="this.style.transform='translateY(0)';this.style.borderColor='rgba(124,58,237,0.5)'">
      <h3>💬 College Messenger</h3>
      <b>Stack:</b> C++20, Boost.Asio, PostgreSQL, WebSockets 📡<br>
      Асинхронный сервер мессенджера: чат-комнаты, история сообщений, авторизация. Разрабатывается в учебных целях для колледжа.<br>
      <i>Async messenger server: rooms, history, auth. In active development.</i><br>
...
> ✨ Планирую: HTTP‑фреймворк на C++ (с поддержкой middleware), простой RPC и открыть contrib к open‑source проектам (например, uWebSockets, Crow).
...
Написать свой EventLoop для демонстрации подхода Reactor

Изучить gRPC и интегрировать с C++

Погрузиться в C++23 (std::mdspan, std::expected, корутины)

Доделать мессенджер и опубликовать Docker-образ
